...
namespace Xtwoend\DataGrid\Engines;

use Illuminate\Http\JsonResponse;
use Illuminate\Support\Str;
use League\Fractal\Resource\Collection;
use Xtwoend\DataGrid\Contracts\DataTableEngineContract;
use Xtwoend\DataGrid\Helper;
use Xtwoend\DataGrid\Processors\DataProcessor;

/**
 * Class BaseEngine.
 *
 * @package Xtwoend\DataGrid\Engines
